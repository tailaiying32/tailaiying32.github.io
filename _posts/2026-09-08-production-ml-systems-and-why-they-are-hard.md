...
One of the biggest issues when it comes to machine learning systems is that things are tightly tangled together. Unlike in traditional software engineering, where strong abstraction and modular design can be enforced and are generally preferred for maintainability, it is very difficult to do the same in ML systems. This concept is often referred to as the **CACE principle: Changing Anything Changes Everything**. We will examine why this is true, and some ways to work around it.
